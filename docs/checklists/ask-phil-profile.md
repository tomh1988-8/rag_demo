...
Profile version: 1.1, 23 September 2026. Applies [reusable checklist v1.1](agent-development.md) to the [agreed Ask Phil specification](../specs/ask-phil.md). The user approved [ticket breakdown v2](../plans/ask-phil-tickets-v2/README.md) on 23 September 2026. The user subsequently required feedback collection and online evaluation; this scope amendment is integrated into the current release. The first deterministic inspection slice has native and Docker acceptance evidence; subsequent tickets remain pending.
...
| AD-02.1 | Pending | [02](../plans/ask-phil-tickets-v2/02-generate-grounded-answer.md) | Deterministic evidence baseline from 01 and versioned always-text-RAG baseline from 02. Initial native-slice evidence is in [issue #2](../implementation/issue-2/README.md); later-slice/full-release requirements remain open. | Source snapshot, answer model or comparison task changes. |
...
| AD-05.1 | Pending | [02](../plans/ask-phil-tickets-v2/02-generate-grounded-answer.md) | Recorded model/prompt/output/context contracts and configurations for actual requests. | Prompt, model, context construction or output contract changes. |
...
| AD-06.2 | Pending | [02](../plans/ask-phil-tickets-v2/02-generate-grounded-answer.md) | Exposed-rule tests, real PostgreSQL/pgvector/application integration and external-only substitutes; extend per slice. Initial native-slice evidence is in [issue #2](../implementation/issue-2/README.md); later-slice/full-release requirements remain open. | Affected rule, integration, dependency or provider contract changes. |
...
| AD-09.1 | Pending | [02](../plans/ask-phil-tickets-v2/02-generate-grounded-answer.md) | Actual redacted request/context/retrieval/model records and evidence appendix, extended for later tools. | Trace/evidence construction, tool or error handling changes. |
...
| AD-09.3 | Pending | [17](../plans/ask-phil-tickets-v2/17-route-and-escalate.md) | Complete serving measurements including routing/retries, separate online and offline evaluation costs and explicit missing usage; ONLINE-03 owns live evaluation accounting. | Routing, retry, provider/pricing or measurement changes. |
...
| RAG-02 | Pending | [02](../plans/ask-phil-tickets-v2/02-generate-grounded-answer.md) | Relevance and sufficient-evidence labels with explicit k/matching/denominators; later route/context comparisons. | Retrieval/context policy, embeddings, corpus or task distribution changes. |
