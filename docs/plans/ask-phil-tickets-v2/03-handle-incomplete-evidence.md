...
Status: approved and published as [GitHub #4](https://github.com/tomh1988-8/rag_demo/issues/4), labelled ready-for-agent; body and label verified on 23 September 2026. Plan version: 2. Implementation has not started.
...
- [ ] Report correctness, groundedness, completeness, citation support and answerability separately. Turn observed critical false-premise, unsupported-negative or false-citation failures into reviewed regression cases.
